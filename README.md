...
SetShot captures a complete snapshot of your Mac's settings, then lets you compare two snapshots to see exactly what changed — and what each change means.

It's designed for situations where you want to know what shifted after a macOS update, a software install, or a session of tweaking options in System Settings.
...
You can keep as many snapshots as you like and compare any pair.
...
**Unrecognized changes** are settings not yet in the knowledge base. You can see the raw technical name and its old and new values. If you recognize what it is, you can submit it — submissions are reviewed and added to the knowledge base, where they benefit everyone.

---

## The Journal

The Journal tab keeps a running history of recognized changes from all your comparisons. Instead of opening individual comparison windows, you can flip to the Journal to see a timeline of everything that's changed on your Mac. Entries are grouped by comparison, searchable, and can be deleted individually or by comparison.
